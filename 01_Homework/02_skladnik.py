"""
Vyvíjíš software pro obchod s elektronickými součástkami. Firma eviduje informace o počtu součástek
na skladě ve slovníku. Klíč slovníku je kód součástky a číslo je počet součástek na skladě.
...
kod = input("Zadejte kód zboží: ")
if kod in sklad:
  pocet = int(input("Zadejte požadované množství: "))
  if pocet > sklad[kod]:
    print("Lze prodat pouze omezené množství kusů. Na skladě máme pouze", sklad[kod], "kusů.")
    sklad.pop(kod)
  else:
